...
const Adminsidebar = () => {
  ...
  return (
    <div className="h-[calc(100vh-64px) md:flex flex-col items-centre pt-8 max-w-13 md:max-w-60 w-full border-r border-gray-300/20 text-sm">
      <img
        src={user.imageurl}
        alt="sidebar"
